...
import PhotoUploadWidget from '../../app/layout/shared/PhotoUploadWidget';
import StarButton from '../../app/layout/shared/StarButton';
import DeleteButton from '../../app/layout/shared/DeleteButton';
      ...
      {editMode ? (
        ...
        <>
          {photos.length === 0 ? (
            ...
            <ImageList sx={{ p: 5 }} cols={6} rowHeight={164}>
              {photos.map((item) => (
